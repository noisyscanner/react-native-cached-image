...
declare module 'react-native-cached-image-ts' {
  namespace CachedImage {
    ...
    interface ImageCacheProviderProps extends CacheProps {
    ...
    interface ImageCacheManager {
      ...
      downloadAndCacheUrl (url: String, options: CacheProps): Promise<any>

      /** Delete the cached image corresponding to the given url */
      deleteUrl (urls: string, options?: CacheProps): Promise<any>
       ...
       */
      seedAndCacheUrl (url: string, seedPath: string, options?: CacheProps): Promise<any>
       ...
       */
      getCacheInfo (options?: CacheProps): Promise<PromiseCacheInfo>
